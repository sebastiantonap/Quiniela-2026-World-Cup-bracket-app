/**
 * FIFA 2026 third-place qualifying-combination table.
 *
 * Key: the 8 qualifying third-place group letters sorted alphabetically (e.g. "ABCDEFGH").
 * Value: for each of the 8 R32 best-third match numbers, the source group letter whose
 * third-place team fills that slot.
 *
 * Source: official FIFA matrix (495 scenarios for choosing 8 of 12 groups).
 */
export const THIRD_PLACE_MATRIX: Record<string, Record<number, string>> = {
...
export const BEST_THIRD_MATCH_NUMBERS = [74, 77, 79, 80, 81, 82, 85, 87] as const
