...
export const es: Dictionary = {
  ...
  'leaderboard.rankDeltaHint': 'Cambio desde la última actualización de puntos',
  'leaderboard.maxTooltip': 'Mejor posición posible si todos los pronósticos restantes son correctos',
  ...
  'rules.qual.body': 'Para cada grupo también eliges quién termina 1°, 2° y 3°. Obtienes el valor completo por acertar la posición exacta, y un punto de consolación si tu equipo igual clasifica a los Dieciseisavos en otra posición.',
  'rules.qual.firstLabel': 'Tu pronóstico de 1er lugar:',
  'rules.qual.firstDesc': '{exact} pts si termina 1° · de lo contrario, {cons} pt si igual clasifica a los Dieciseisavos en otra posición.',
  'rules.qual.secondLabel': 'Tu pronóstico de 2do lugar:',
  'rules.qual.secondDesc': '{exact} pts si termina 2° · de lo contrario, {cons} pt si igual clasifica a los Dieciseisavos en otra posición.',
  'rules.qual.thirdLabel': 'Tu pronóstico de 3er lugar:',
  'rules.qual.thirdDesc': '{exact} pts solo si termina 3° Y clasifica como uno de los 8 mejores terceros · de lo contrario, {cons} pt si en cambio termina 1° o 2°. Un tercero que no entre entre los 8 mejores no suma nada.',
  'rules.qual.note': 'El punto de consolación ({cons} pt) aplica siempre que tu equipo elegido llegue a los Dieciseisavos — como líder de grupo, subcampeón o uno de los 8 mejores terceros — aunque termine en una posición distinta a la que pronosticaste. Un equipo que no clasifica suma 0.',
  'rules.best.heading': 'Los 8 mejores terceros',
  'rules.best.body': 'Doce equipos terminan 3° en su grupo, pero solo 8 avanzan a los Dieciseisavos. Tú eliges cuáles 8 crees que lo logran. Cada equipo que elijas que realmente avance vale {pts} punto. Debes seleccionar exactamente 8.',
  ...
  'admin.results.overrideBadge': 'Manual',
  'admin.results.driftBadge': 'Discrepancia',
  'admin.results.apiScore': 'API: {home}–{away}',
  'admin.results.revertToApi': 'Revertir a API',
  'admin.results.revertConfirm': '¿Revertir este partido al resultado de la API?',
  'admin.results.reverted': 'Revertido a API',
  ...
  'admin.sync.teamsMapped': 'Equipos mapeados',
  'admin.sync.teamsNotMapped': 'Equipos sin mapear',
  'admin.sync.matchesMapped': 'Partidos mapeados',
  ...
  'admin.sync.col.changed': 'Cambiados',
  'admin.sync.col.drift': 'Discrepancia',
  'admin.sync.col.error': 'Error',

  // ---- admin: change history ----
  'admin.history.filterAll': 'Todos',
  'admin.history.filterApi': 'API',
  'admin.history.filterManual': 'Manual',
  'admin.history.matchPlaceholder': 'Partido #',
  'admin.history.noEntries': 'Sin historial de cambios aún.',
  'admin.history.col.time': 'Hora',
  'admin.history.col.match': 'Partido',
  'admin.history.col.field': 'Campo',
  'admin.history.col.change': 'Cambio',
  'admin.history.col.source': 'Fuente',
